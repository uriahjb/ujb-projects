...
%  for purpose of testing and pulling in data from a mobile robot 
...
opt.source          = struct('tcp_stream',0,'input','_bot/'); % camera/directory with, directory_name, initial_bounding_box (if empty, it will be selected by the user)
